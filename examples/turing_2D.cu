// Simulate a Turing mechanism within a 2D epithelium
// Meinhard equations
...
MAKE_PT(Epi_cell, x, y, z, theta, phi, u, v);


__device__ Epi_cell epithelium_w_turing(Epi_cell Xi, Epi_cell Xj, int i, int j) {
    Epi_cell dF {0};
