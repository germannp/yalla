...
#define _MAP10(MACRO, x, ...) MACRO(x); _MAP9(MARCO, __VA_ARGS__)
...
#define _MAP20(MACRO, x, ...) MACRO(x); _MAP19(MARCO, __VA_ARGS__)
...
#define _MAP30(MACRO, x, ...) MACRO(x); _MAP29(MARCO, __VA_ARGS__)
...
#define _MAP40(MACRO, x, ...) MACRO(x); _MAP39(MARCO, __VA_ARGS__)
